...
from monitor.raises import raise_monitor_not_found

router = APIRouter(redirect_slashes=True)


@router.get("", description="Get average ping")
...
@router.get("/{monitor_id}", description="Get average ping by monitor ID")
